...
namespace PetShop
{
    public partial class FrmStockCama : FrmStockBase
    {
        public FrmStockCama()
        {
            InitializeComponent();
            ...
            if (IdActual != 0)
            {
                ...
                else
                {
                    ...
                    if (actualProducto != null)
                    {
                        ...
                        this.cmb_extra.SelectedItem = ((Cama)actualProducto).Tamanio;
                        this.checkBox1.Checked = ((Cama)actualProducto).ConBase;
                    }
                }
            }
        ...
        private void FrmStockCama_Load(object sender, EventArgs e)
        {
            ...
            this.cmb_extra.DataSource = Enum.GetValues(typeof(ETamanoCama));
        ...
        private void btn_stock_Click(object sender, EventArgs e)
        {
                ...
                this.cmb_mascota.SelectedItem != null)
            {
                ...
                tamano = (ETamanoCama)this.cmb_extra.SelectedItem;

                nuevoProd = new Cama(nombre, precio, cantidad, paraMascota, bajoReceta, tamano);
